      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <button
              onClick={addNewRow}
              className="bg-green-500 text-white px-5 py-2.5 rounded-lg hover:bg-green-600 transition-all duration-200 font-semibold flex items-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-t border-blue-200 p-4">
        <div className="flex items-center">
          ...
          <p className="text-sm text-gray-700">
            <span className="font-bold text-blue-700">Подсказка:</span> Кликните на любую ячейку для редактирования. 
            Нажмите <kbd className="px-2 py-1 mx-1 bg-white border-2 border-gray-300 rounded text-xs font-bold shadow-sm">Enter</kbd> для сохранения, 
            <kbd className="px-2 py-1 mx-1 bg-white border-2 border-gray-300 rounded text-xs font-bold shadow-sm">Esc</kbd> для отмены.
          </p>
        </div>
      </div>
    </div>
